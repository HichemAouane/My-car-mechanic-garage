...
import java.awt.event.ActionEvent;
	...
	public class ListerModMar extends JFrame{
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						ListerModMar frame = new ListerModMar(connection1,stmt1);
		...
		public ListerModMar(Connection connection ,Statement stmt) {
			setTitle(" Liste des vehiculs et leurs marques ");
			...
			btnAfficher.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						rs = stmt1.executeQuery("Select marque, nummodele, modele from marque, modele where marque.nummarque=modele.nummarque");
			...
			JLabel lblVeuillezSvpInserer = new JLabel("Liste des vehiculs et leurs marques :");
