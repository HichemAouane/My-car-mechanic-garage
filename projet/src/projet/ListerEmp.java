...
public class ListerEmp extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListerEmp frame = new ListerEmp(connection1,stmt1);
	...
	public ListerEmp(Connection connection ,Statement stmt) {
		setTitle("Affichage des employes par lettre du nom ");
		...
		textField.setBounds(139, 155, 233, 26);
		...
		btnAfficher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					rs = stmt1.executeQuery("select * from employe where NOMEMP LIKE '"+textField.getText()+"%'");
		...
		JLabel lblVeuillezSvpInserer = new JLabel("Veuillez svp inserer une lettre");
		lblVeuillezSvpInserer.setFont(new Font("Tahoma", Font.PLAIN, 19));
		lblVeuillezSvpInserer.setBounds(139, 66, 251, 50);
